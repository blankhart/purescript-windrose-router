-- https://github.com/slamdata/purescript-halogen/tree/master/examples/driver-routing/src

module Example.Halogen.Main where
...
import Example.Halogen.Component as RouteLog
import Halogen as H
